 ...
 */
public class JpegJstegDecode implements StegoDecodingAlgorithm, JpegImageConstants {

   /** LOGGER */
   private static final Logger LOGGER = LoggerFactory.getLogger(JpegJstegDecode.class);
   ...
   private void decodeFromCbChroma(BitBuffer aBitBuffer, int aMaxSize, int aRow, int aColumn, int aValue) {
      ...
      if (((cbChromaValue != 0) && (cbChromaValue != 1)) && (bitPosition < aMaxSize)) {
   ...
   private void decodeFromCrChroma(BitBuffer aBitBuffer, int aMaxSize, int aRow, int aColumn, int aValue) {
      ...
      if (((crChromaValue != 0) && (crChromaValue != 1)) && (bitPosition < aMaxSize)) {
   ...
   private void decodeFromYLuma(BitBuffer aBitBuffer, int aMaxSize, int aRow, int aColumn, int aValue) {
      ...
      if (((yLumaValue != 0) && (yLumaValue != 1)) && (bitPosition < aMaxSize)) {
