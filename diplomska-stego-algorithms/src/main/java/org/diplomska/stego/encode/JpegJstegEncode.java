 ...
 */
public class JpegJstegEncode implements StegoEncodingAlgorithm, JpegImageConstants {

   /** LOGGER */
   private static final Logger LOGGER = LoggerFactory.getLogger(JpegJstegEncode.class);
    ...
    */
   public JpegJstegEncode(JpegImageContext aJpegImageContext) {
   ...
   private void encodeIntoCbChroma(BitWalker aBitWalker, int aRow, int aColumn, int aValue) {
      ...
      if (((cbChromaValue != 0) && (cbChromaValue != 1)) && (bitPosition < numOfBitsInMessage)) {
   ...
   private void encodeIntoCrChroma(BitWalker aBitWalker, int aRow, int aColumn, int aValue) {
      ...
      if (((crChromaValue != 0) && (crChromaValue != 1)) && (bitPosition < numOfBitsInMessage)) {
         Byte messageBit       = aBitWalker.getBit(bitPosition);
   ...
   private void encodeIntoYLuma(BitWalker aBitWalker, int aRow, int aColumn, int aValue) {
      ...
      if (((yLumaValue != 0) && (yLumaValue != 1)) && (bitPosition < numOfBitsInMessage)) {
         Byte messageBit    = aBitWalker.getBit(bitPosition);
