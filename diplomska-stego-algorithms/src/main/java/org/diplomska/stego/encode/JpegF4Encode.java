 ...
 */
public class JpegF4Encode implements StegoEncodingAlgorithm, JpegImageConstants {

   /** LOGGER */
   private static final Logger LOGGER = LoggerFactory.getLogger(JpegF4Encode.class);
    ...
    */
   public JpegF4Encode(JpegImageContext aJpegImageContext) {
