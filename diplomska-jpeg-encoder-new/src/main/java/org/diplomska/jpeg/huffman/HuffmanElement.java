...
public class HuffmanElement {
   ...
   public HuffmanElement(Byte aValue, long aFrequency, int aHuffmanCodeLength) {
      ...
      fBitRepresentationOfValue = convertValueTo8BitArray(fValue);
   }
    ...
    * @return
    */
   public List<HuffmanElement> getHuffmanElements() {
    ...
    * @param aCodeLength
    */
   public void setCodeLength(int aCodeLength) {
    ...
    * @return
    */
   private byte[] convertValueTo8BitArray(Byte aValue) {
