...
public class JpegImageBlockProcessor {
    ...
    * @return
    */
   public JpegImageBlockProcessorStep putBlockStep(String aName, JpegImageBlockProcessorStep aImageProcessorStep) {
    ...
    * @return
    */
   public JpegImageProcessorStep putImageStep(String aName, JpegImageProcessorStep aJpegImageProcessorStep) {
