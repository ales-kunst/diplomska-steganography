...
public class RunLengthCodingStructure {
   ...
   public int getCoefficientNumber() {
      return JpegImageUtils.convertFromEncodedValueToCoefficientValue(fNumberOfBits, fEncodedZrlcNumber);
   }
   ...
   public byte[] toBits() {
      ...
      for (byte bit : JpegImageUtils.encodeToBitCodedRepresentation(getCoefficientNumber())) {
